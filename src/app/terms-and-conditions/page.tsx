...
export const metadata: Metadata = {
  title: "Terms and Conditions - Sistem Rekam Medis",
          ...
          <div className="flex flex-col gap-8">
            <div className="space-y-4">
              <p className="text-[#4b4f58]">
                Welcome to medital! These terms and conditions outline the rules
                and regulations for the use of meditals Website, located at
                https://medital.id/.
              </p>
              <p className="text-[#4b4f58]">
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use medital if you do not agree
            ...
            <div className="space-y-4">
              <h2 className="text-3xl font-bold text-[#3a3a3a]">Cookies</h2>
              <p className="text-[#4b4f58]">
                We employ the use of cookies. By accessing medital, you agreed
                to use cookies in agreement with the meditals Privacy Policy.
              </p>
              <p className="text-[#4b4f58]">
                Most interactive websites use cookies to let us retrieve the
                users details for each visit. Cookies are used by our website to
            ...
            <div className="space-y-4">
              <h2 className="text-3xl font-bold text-[#3a3a3a]">License</h2>
              <p className="text-[#4b4f58]">
                Unless otherwise stated, medital and/or its licensors own the
                intellectual property rights for all material on medital. All
                intellectual property rights are reserved. You may access this
                from medital for your own personal use subjected to restrictions
                set in these terms and conditions.
              </p>
              <p className="text-[#4b4f58]">You must not:</p>
              <ul className="list-disc pl-4 text-[#4b4f58]">
                <li>Republish material from medital</li>
                <li>Sell, rent or sub-license material from medital</li>
                <li>Reproduce, duplicate or copy material from medital</li>
                <li>Redistribute content from medital</li>
              </ul>
              <p className="text-[#4b4f58]">
              ...
              <p className="text-[#4b4f58]">
                medital reserves the right to monitor all Comments and to remove
                any Comments which can be considered inappropriate, offensive or
                causes breach of these Terms and Conditions.
              </p>
              <p className="text-[#4b4f58]">You warrant and represent that:</p>
              <ul className="list-disc pl-4 text-[#4b4f58]">
                <li>
              ...
              <p className="text-[#4b4f58]">
                You hereby grant medital a non-exclusive license to use,
            ...
            <div className="space-y-4">
              ...
              <p className="text-[#4b4f58]">
                ...
                of medital; and (d) the link is in the context of general
              ...
              <p className="text-[#4b4f58]">
                ...
                by sending an e-mail to medital. Please include your name, your
              ...
              <p className="text-[#4b4f58]">
                No use of meditals logo or other artwork will be allowed for
                linking absent a trademark license agreement.
              </p>
            </div>

            <div className="space-y-4">
              <h2 className="text-3xl font-bold text-[#3a3a3a]">iFrames</h2>
              <p className="text-[#4b4f58]">
            ...
            <div className="space-y-4">
              <h2 className="text-3xl font-bold text-[#3a3a3a]">Disclaimer</h2>
              <p className="text-[#4b4f58]">
